			...
			<div style="width:100%;height:100%;display:flex;justify-content:flex-end;align-items:center;">
				...
				<div style="<?php echo e($cardStyle); ?>">
					<!-- Logo (if present) positioned top-right in the card -->
						<?php if($logoFile): ?>
							<img src="<?php echo e(asset($logoFile)); ?>" alt="DineCraft logo" style="position:absolute;right:12px;top:12px;width:96px;height:auto;border-radius:6px;box-shadow:0 6px 16px rgba(0,0,0,0.08);background:rgba(255,255,255,0.6);padding:6px;" />
						<?php endif; ?>
